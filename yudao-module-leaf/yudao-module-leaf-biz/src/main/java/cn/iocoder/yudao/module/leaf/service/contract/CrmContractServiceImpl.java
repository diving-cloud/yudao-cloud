...
import cn.iocoder.yudao.module.leaf.controller.admin.contract.vo.contract.CrmContractPageReqVO;
import cn.iocoder.yudao.module.leaf.controller.admin.contract.vo.contract.CrmContractSaveReqVO;
...
import cn.iocoder.yudao.module.leaf.dal.dataobject.contract.CrmContractProductDO;
import cn.iocoder.yudao.module.leaf.dal.mysql.contract.CrmContractMapper;
import cn.iocoder.yudao.module.leaf.dal.mysql.contract.CrmContractProductMapper;
import cn.iocoder.yudao.module.leaf.dal.redis.no.CrmNoRedisDAO;
import cn.iocoder.yudao.module.leaf.enums.common.CrmAuditStatusEnum;
...
import cn.iocoder.yudao.module.leaf.service.receivable.CrmReceivableService;
...
import static cn.iocoder.yudao.module.leaf.util.CrmAuditStatusUtils.convertBpmResultToAuditStatus;
...
public class CrmContractServiceImpl implements CrmContractService {
     ...
     * BPM 合同审批流程标识
     */
    public static final String BPM_PROCESS_DEFINITION_KEY = "leaf-contract-audit";
